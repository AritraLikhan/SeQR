...
public class NotVerified extends Fragment {
    ...
    public static NotVerified newInstance(String uid) {
        NotVerified fragment = new NotVerified();
    ...
    public static NotVerified newInstance(String param1, String param2) {
        NotVerified fragment = new NotVerified();
        Bundle args = new Bundle();
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_not_verified, container, false);

        textView = view.findViewById(R.id.idNotVerified);
